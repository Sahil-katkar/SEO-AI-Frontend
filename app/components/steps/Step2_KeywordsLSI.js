...
export default function Step2_KeywordsLSI() {
  ...
  return (
    <div className="step-component">
      <h3>2. Keyword Research & LSI</h3>
      <label htmlFor="primaryKeyword">Primary Keyword:</label>
      <input
        type="text"
        id="primaryKeyword"
        value={projectData.primaryKeyword}
        onChange={(e) => updateProjectData({ primaryKeyword: e.target.value })}
        placeholder="e.g., green tea"
      />
      <button onClick={handleGenerateLSI} disabled={isLoading || !projectData.primaryKeyword}>
