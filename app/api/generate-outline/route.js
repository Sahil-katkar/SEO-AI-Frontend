...
export async function POST(request) {
  ...
  console.log(
    `Next.js API: Forwarding request to Python backend at ${PYTHON_API_GENERATE_OUTLINE_URL}`
  );
  ...
  let pythonResponse;
  try {
    pythonResponse = await fetch(`${PYTHON_API_GENERATE_OUTLINE_URL}`, {
      method: "POST",
      headers: {
    ...
    const errorMessage = `Error communicating with the backend API at ${PYTHON_API_GENERATE_OUTLINE_URL}. Please ensure the api_server.py process is running and accessible.`;
